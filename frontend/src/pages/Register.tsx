...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Building, UserCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center p-12">
          <Link to="/" className="flex items-center gap-2 mb-12">
            <div className="w-12 h-12 rounded-xl luxe-gradient flex items-center justify-center shadow-lg">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-md">
            Create an account to unlock exclusive deals, manage your bookings, and experience luxury travel like never before.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-6 animate-fade-in">
          ...
          {/* Role Toggle */}
          <div className="flex gap-4 p-1.5 bg-secondary rounded-xl">
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" variant="luxe" className="w-full" size="lg" disabled={isLoading}>
              {isLoading ? (
